...
2. **Data ingestion**: implement daily data adapter, download 3-year S&P 100 dataset, store as Parquet.
3. **Backtest skeleton**: build event loop, portfolio accounting, and commission/slippage models.
4. **Mean reversion strategy module**: code signal, position sizing, exits, risk limits with unit tests.
5. **Experiment #1**: baseline parameter sweep over 2012–2024 (train 2012–2022, validate 2023, test 2024S YTD).
6. **Reporting**: generate initial performance report and document findings/background assumptions.
