...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Download QuantConnect daily bars into Parquet cache.")
    ...
    parser.add_argument("--years", type=int, default=3,
                        help="Lookback window in years when --start omitted (default: 3).")
    parser.add_argument(
        "--universe", help="Universe name under data/raw/universe to expand symbols (e.g., snp100).")
    parser.add_argument("--universe-file", type=Path,
                        help="Explicit path to universe membership Parquet file.")
    parser.add_argument(
        "--effective-date", help="Filter universe membership to a specific effective date (YYYY-MM-DD). Defaults to latest.")
